...
Strategy.prototype.authenticate = function(req) {
  ...
  async.auto({
    ...
    checkRequest: ['parseRequest', (callback, results) => {
    ...
    getPublicKey: ['checkRequest', (callback, results) => {
    ...
    validatePublicKey: ['getPublicKey', (callback, results) => {
    ...
    verify: ['validatePublicKey', (callback, results) => {
      let verified;
      try {
    ...
    validateNonce: ['validateHost', (callback, results) => {
    ...
    getIdentity: ['validateNonce', (callback, results) => {
...
function getHttpsPublicKey(publicKey, callback) {
  ...
  async.auto({
    ...
    verifyKey: ['dereferencePublicKey', (callback, results) => {
