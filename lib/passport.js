...
api.checkAuthentication = function(req, res, options, callback) {
  ...
  if(req.isAuthenticated()) {
    // allow session-based authentication when:
...
bedrock.events.on('bedrock-express.configure.static', function configure(app) {
  ...
  passport.serializeUser(function(user, callback) {
    // TODO: support saving custom info from the strategy in session
    // save identity ID
  ...
  passport.deserializeUser(function(data, callback) {
    ...
    async.auto({
      getIdentity: function(callback) {
        ...
        // TODO: support case where identity isn't locally stored and
        // strategy custom stores information
